...
export default defineNuxtConfig({
    ...
    app: {
        head: {
            ...
            meta: [
                { name: 'description', content: '16 years old frontend & backend developer and student from Turkey.' },
                { name: 'twitter:card', content: 'summary' },
                { name: 'twitter:site', content: '@b2rbecue' },
                { name: 'twitter:site', content: '@b2rbecue' },
                { name: "twitter:title",  content: "tuna.one" },
                { name: "twitter:description",  content: "16 years old frontend & backend developer and student from Turkey." },
                { name: "twitter:image",  content: "https://tuna.one/assets/images/tuna.png" },
                { name: "og:type",  content: "website" },
                { name: "og:site_name",  content: "tuna.one" },
                { name: "og:description",  content: "16 years old frontend & backend developer and student from Turkey." },
                { name: "og:image",  content: "https://tuna.one/assets/images/tuna.png" },
                { name: "msapplication-TileImage",  content: "#171717" },
                { name: "msapplication-TileImage",  content: "/assets/images/meta/ms-icon-144x144.png" },
