...
<template>
  <nuxt-link
    ...
    class="flex h-28 hover:scale-105 transform cursor-pointer items-center rounded-md border border-gray-300 p-4 text-white duration-300 hover:bg-gray-200 dark:border-neutral-800 dark:hover:bg-black"
  >
